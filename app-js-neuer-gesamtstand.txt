...
const translations = {
    de: {
        ...
        finishText: "Fertig",
        finishTitle: "Vielen Dank!",
        finishMessage: "Deine Schätze wurden sichtbar gemacht.",
        finishNote: "In dieser Testversion werden die Angaben noch nicht gespeichert.",
        restartText: "Neu beginnen"
    },
    en: {
        title: "🌱 Treasure Hunt",
        ...
        finishText: "Finish",
        finishTitle: "Thank you!",
        finishMessage: "Your treasures have been made visible.",
        finishNote: "Your information is not yet saved in this test version.",
    ...
    fr: {
        ...
        finishText: "Terminer",
        finishTitle: "Merci !",
        finishMessage: "Vos trésors ont été rendus visibles.",
        finishNote: "Dans cette version de test, vos informations ne sont pas encore enregistrées.",
    ...
    ar: {
        ...
        finishText: "إنهاء",
        finishTitle: "شكرًا لك!",
        finishMessage: "لقد أصبحت كنوزك مرئية.",
        finishNote: "في هذه النسخة التجريبية، لم يتم حفظ معلوماتك بعد.",
        restartText: "البدء من جديد"
    },
    uk: {
        title: "🌱 Пошук скарбів",
        ...
        finishText: "Завершити",
        finishTitle: "Дякуємо!",
        finishMessage: "Ваші скарби стали видимими.",
        finishNote: "У цій тестовій версії ваші дані ще не зберігаються.",
        restartText: "Почати знову"
    },
    tr: {
        title: "🌱 Hazine Avı",
        ...
        finishText: "Bitir",
        finishTitle: "Teşekkürler!",
        finishMessage: "Hazineleriniz görünür hale geldi.",
        finishNote: "Bu test sürümünde bilgileriniz henüz kaydedilmiyor.",
        restartText: "Yeniden başla"
    },
    vi: {
        ...
        finishTitle: "Cảm ơn bạn!",
        finishMessage: "Những kho báu của bạn đã được thể hiện.",
        finishNote: "Trong phiên bản thử nghiệm này, thông tin của bạn chưa được lưu.",
        restartText: "Bắt đầu lại"
    },
    ru: {
        ...
        finishTitle: "Спасибо!",
        finishMessage: "Ваши сокровища стали видимыми.",
        finishNote: "В этой тестовой версии ваши данные пока не сохраняются.",
...
function applyLanguage(language) {
    ...
    finishButton.textContent = text.finishText;
    document.querySelector("#finish-title").textContent = text.finishTitle;
    document.querySelector("#finish-text").textContent = text.finishMessage;
    document.querySelector("#finish-note").textContent = text.finishNote;
    restartButton.textContent = text.restartText;
...
function buildSummary() {
    ...
    const valueOrEmpty = (selector) =>
        document.querySelector(selector).value.trim() || text.emptyText;
    const selectedTalents = [
        ...talentGrid.querySelectorAll(".card.selected .language-name")
    ]
    ...
    document.querySelector("#summary-content").innerHTML = `
        <section class="summary-section">
            <div class="summary-heading">
                ...
                <button class="edit-button" type="button" data-edit-page="about-page">
                    ${text.editText}
                </button>
            </div>
        ...
        <section class="summary-section">
            <div class="summary-heading">
                ...
                <button class="edit-button" type="button" data-edit-page="talents-page">
                    ${text.editText}
                </button>
            </div>
            <p>${selectedTalents}</p>
        ...
        <section class="summary-section">
            <div class="summary-heading">
                ...
                <button class="edit-button" type="button" data-edit-page="hidden-treasures-page">
                    ${text.editText}
                </button>
            </div>
        ...
        <section class="summary-section">
            <div class="summary-heading">
                ...
                <button class="edit-button" type="button" data-edit-page="support-page">
                    ${text.editText}
                </button>
            </div>
...
document.querySelector("#summary-content").addEventListener("click", (event) => {
    ...
    document.querySelector(`#${editButton.dataset.editPage}`).hidden = false;
});
...
finishButton.addEventListener("click", () => {
    document.querySelector("#summary-page").hidden = true;
    document.querySelector("#finish-page").hidden = false;
});
